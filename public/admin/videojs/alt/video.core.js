/**
 * @license
 * Resource.js 7.6.0 <http://videojs.com/>
...
(function (global, factory) {
  ...
  function createLogger(name) {
     ...
     *
     * Levels provided by Resource.js are:
     *
     * - `off`: Matches no calls. Any value that can be cast to `false` will have
     *   this effect. The most restrictive.
     * - `all`: Matches only Resource.js-provided functions (`debug`, `log`,
   ...
   * user interaction based on the data-setup `attribute` of the resource tag.
   *
   * @module setup
   */
  ...
  var autoSetup = function autoSetup() {
    ...
    var divs = Array.prototype.slice.call(document.getElementsByTagName('resource-js'));
      ...
      for (var i = 0, e = mediaEls.length; i < e; i++) {
        ...
        if (mediaEl && mediaEl.getAttribute) {
          ...
          if (mediaEl.player === undefined) {
            ...
            if (options !== null) {
              // Create new resource.js instance.
              videojs(mediaEl);
            }
   ...
   *           example, if this function should be tied to a Resource.js player,
  ...
  function () {
     ...
     * support toggling the controls through a tap on the resource. They get enabled
     ...
     * on the resource turns the controls off. Then the `touchend` event bubbles up to
   ...
   *        - `MediaError` (native): used to populate a resource.js `MediaError` object
   *        - `MediaError` (resource.js): will return itself if it's already a
   *          resource.js `MediaError` object.
   *
   ...
   * resource spec but allows for more informative custom errors.
   *
   * @type {String}
   */
  ...
  /**
   * The `ModalDialog` displays over the resource and its controls, which blocks
  ...
  function (_EventTarget) {
     ...
     *
     * @param {Track} track
     *        The audio, resource, or text track to add to the list.
     *
     ...
     *
     * @param {Track} rtrack
     *        The audio, resource, or text track to remove from the list.
     *
  ...
  var disableOthers$1 = function disableOthers(list, track) {
    for (var i = 0; i < list.length; i++) {
      if (!Object.keys(list[i]).length || track.id === list[i].id) {
        continue;
      } // another resource track is enabled, disable it
  ...
  /**
   * The current list of {@link VideoTrack} for a resource.
   *
  ...
  */
  ...
  var loadTrack = function loadTrack(src, track) {
    ...
    xhr(opts, bind(this, function (err, response, responseBody) {
      ...
      // NOTE: this is only used for the alt/resource.novtt.js build
  ...
  function moveBoxToLinePosition(window, styleBox, containerBox, boxPositions) {
    // Find the best position for a cue box, b, on the resource. The axis parameter
    ...
    if (cue.snapToLines) {
      ...
      // relative to the bottom of the resource instead of the top. Therefore, we
      // need to increase our initial position by the length or width of the
      // resource, depending on the writing direction, and reverse our axis directions.
   ...
   * * `var SourceObject = {src: 'http://ex.com/video.mp4', type: 'resource/mp4'};`
  ...
  function (_Component) {
    ...
    */
    function Tech(options, ready) {
      ...
      ['Text', 'Audio', 'Resource'].forEach(function (track) {
    ...
    /**
     * Get the percentage of the current resource that is currently buffered.
     *
     * @return {number}
     *         A number from 0 to 1 that represents the decimal percentage of the
     *         resource that is buffered.
     *
     */
    ;
    ...
    _proto.trackCurrentTime = function trackCurrentTime() {
      ...
      this.currentTimeInterval = this.setInterval(function () {
        /**
         * Triggered at an interval of 250ms to indicated that time is passing in the resource.
         *
    ...
    _proto.stopTrackingCurrentTime = function stopTrackingCurrentTime() {
      this.clearInterval(this.currentTimeInterval); // #1002 - if the resource ends right before the next timeupdate would happen,
     ...
     *
     * > Note: Techs without source handlers should call this between sources for `resource`
     *         & `audio` tracks. You don't want to use them between tracks!
     *
     * @param {string[]|string} types
     *        TrackList names to clear, valid names are `resource`, `audio`, and
     *        `text`.
     */
    ;
     ...
     *
     * @return {TimeRange}
     *         - A single time range if this resource has played
     ...
     *        - When false: the TextTrack will be automatically removed from the resource
    ...
    _proto.addRemoteTextTrack = function addRemoteTextTrack(options, manualCleanup) {
      ...
      if (manualCleanup !== true && manualCleanup !== false) {
        // deprecation warning
        log.warn('Calling addRemoteTextTrack without explicitly setting the "manualCleanup" parameter to `true` is deprecated and default to `false` in future version of resource.js');
        manualCleanup = true;
    ...
    /**
     * Attempt to create a floating resource window always on top of other windows
    ...
    /**
     * A method to check for the presence of the 'playsinline' <resource> attribute.
     *
     * @abstract
     */
    ;
    ...
    /**
     * A method to set or unset the 'playsinline' <resource> attribute.
     *
     * @abstract
     */
    ;
    ...
    /**
     * Attempt to force override of native resource tracks.
     *
     * @param {boolean} override - If set to true native resource will be overridden,
     * otherwise native resource will potentially be used.
     *
     * @abstract
     */
    ;
     ...
     * @return {string} Returns the native resource element's response
     */
    ;
  ...
  /**
   * List of associated resource tracks.
   *
   * @type {VideoTrackList}
   * @private
  ...
  /**
   * Boolean indicating whether the `Tech` supports changing the speed at which the resource
   * plays. Examples:
   ...
   * not triggered by resource-js-swf. This will be used to determine if
   ...
   * manually load resource data and feed it into a Source Buffer (Media Source Extensions)
  ...
  /**
   * A `ClickableComponent` that handles showing the poster level for the player.
   *
  ...
  function (_Component) {
    ...
    _proto.createEl = function createEl$1() {
      ...
      var playerType = this.localize(isAudio ? 'Audio Player' : 'Resource Player');
  ...
  /**
   * The initial play button that shows before the resource has played. The hiding of the
  ...
  BigPlayButton.prototype.controlText_ = 'Play Resource';
  ...
  function (_Button) {
    ...
    /**
     * This gets called once after the resource has ended and the user seeks so that
  ...
  /**
   * Displays time information about the resource
   *
   * @extends Component
   */
  ...
  /**
   * Displays the time left in the resource
   *
   * @extends Component
   */
   ...
   * For instance the volume bar or the seek bar on a resource is a slider.
   *
   * @extends Component
   */
  ...
  function (_Slider) {
    ...
    _proto.handleMouseMove = function handleMouseMove(event) {
      ...
      if (!liveTracker || !liveTracker.isLive()) {
        newTime = distance * this.player_.duration(); // Don't let resource end while scrubbing.
        ...
        newTime = seekableStart + distance * liveTracker.liveWindow(); // Don't let resource end while scrubbing.
  ...
  /**
   * A display that indicates an error has occurred. This means that the resource
   * is unplayable.
   *
   * @extends ModalDialog
   */
  ...
  function (_Component) {
    ...
    _proto.startTracking = function startTracking() {
      ...
      // before a resource starts to play
  ...
  function (_Tech) {
    ...
    */
    function Html5(options, ready) {
      ...
      if (_this.el_.hasChildNodes()) {
        ...
        while (nodesLength--) {
          ...
          if (nodeName === 'track') {
            if (!_this.featuresNativeTextTracks) {
              // Empty resource tag tracks so the built-in player doesn't use them also.
     ...
     * 'Resource', and 'Text'.
     * @param {boolean} override - If set to true native audio/resource will be overridden,
     * otherwise native audio/resource will potentially be used.
     * @private
     */
    ;
    ...
    _proto.overrideNativeVideoTracks = function overrideNativeVideoTracks(override) {
      this.overrideNative_('Resource', override);
    }
    /**
     * Proxy native track list events for the given type to our track
     * lists if the browser we are playing in supports that type of track list.
     *
     * @param {string} name - Track type; values include 'audio', 'resource', and 'text'
     * @private
     */
    ;
    ...
    _proto.createEl = function createEl() {
      ...
      // On the iPhone resource will break if you move the element,
    ...
    _proto.handleLateInit_ = function handleLateInit_(el) {
      if (el.networkState === 0 || el.networkState === 3) {
        // The resource element hasn't started loading the source yet
    ...
    _proto.setCurrentTime = function setCurrentTime(seconds) {
      try {
        ...
        log(e, 'Resource is not ready. (Resource.js)'); // this.warning(VideoJS.warnings.videoNotReady);
      }
    }
    /**
      ...
      if (this.el_.duration === Infinity && IS_ANDROID && IS_CHROME && this.el_.currentTime === 0) {
        ...
        var checkProgress = function checkProgress() {
          if (_this5.el_.currentTime > 0) {
            // Trigger durationchange for genuinely live resource
    ...
    _proto.enterFullScreen = function enterFullScreen() {
      ...
      if (video.paused && video.networkState <= video.HAVE_METADATA) {
        // attempt to prime the resource element for programmatic access
    ...
    /**
     * Create a floating resource window always on top of other windows so that users may
     ...
     * automatically removed from the resource element whenever the source changes
     * @return {HTMLTrackElement} An Html Track Element.
     * This can be an emulated {@link HTMLTrackElement} or a native one.
     * @deprecated The default value of the "manualCleanup" parameter will default
     * to "false" in upcoming versions of Resource.js
     */
    ;
  ...
  /**
   * Check if we can override a resource/audio elements attributes, with
   ...
   * that the url of an level file that can/will be shown when no media data is available.
   *
   * @method Html5#poster
   * @return {string}
  ...
  'readyState',
  /**
   * Get the value of `videoWidth` from the resource element. `videoWidth` indicates
   * the current width of the resource in css pixels.
   *
   * @method Html5#videoWidth
   * @return {number}
   *         The value of `videoWidth` from the resource element. This will be a number
   *         in css pixels.
   *
  ...
  'videoWidth',
  /**
   * Get the value of `videoHeight` from the resource element. `videoHeight` indicates
   * the current height of the resource in css pixels.
   *
   * @method Html5#videoHeight
   * @return {number}
   *         The value of `videoHeight` from the resource element. This will be a number
   *         in css pixels.
   *
   * @see [Spec] {@link https://www.w3.org/TR/html5/embedded-content-0.html#dom-video-videowidth}
   */
   ...
   * an level file that can/will be shown when no media data is available.
   *
   * @method Html5#setPoster
   * @param {string} poster
   *        The url to an level that should be used as the `poster` for the media
   *        element.
   *
   ...
   * after a resource has started will do nothing. Instead you should used {@link Html5#setPlaybackRate}.
   *
   * Example Values:
   *   - if playbackRate is set to 2, media will play twice as fast.
   *   - if playbackRate is set to 0.5, media will play half as fast.
  ...
  Html5.nativeSourceHandler.canHandleSource = function (source, options) {
    ...
    if (source.type) {
      return Html5.nativeSourceHandler.canPlayType(source.type); // If no type, fall back to checking 'resource/[EXTENSION]'
    } else if (source.src) {
      var ext = getFileExtension(source.src);
      return Html5.nativeSourceHandler.canPlayType("resource/" + ext);
    }
  ...
  function _templateObject$2() {
    var data = _taggedTemplateLiteralLoose(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/resource.js/issues/2617 for more info.\n      "]);
  ...
  'progress',
  /**
   * Fires when the loading of an audio/resource is aborted.
   *
   * @event Player#abort
   * @type {EventTarget~Event}
   */
  ...
  'stalled',
  /**
   * Fires when the browser has loaded meta data for the audio/resource.
   *
  ...
  'loadedmetadata',
  /**
   * Fires when the browser has loaded the current frame of the audio/resource.
   *
  ...
  'timeupdate',
  /**
   * Fires when the resource's intrinsic dimensions change
   *
   * @event Player#resize
   * @type {event}
   */
  ...
  /**
   * An instance of the `Player` class is created when any of the Resource.js setup methods
   * are used to initialize a resource.
   *
  ...
  function (_Component) {
     ...
     *
     * @param {Element} tag
     *        The original resource DOM element used for configuring options.
     *
     * @param {Object} [options]
     *        Object of option names and values.
     *
    ...
    function Player(tag, options, ready) {
      ...
      // The options argument overrides options set in the resource tag
      ...
      if (_this.isAudio()) {
        ...
        _this.el_.setAttribute('aria-label', _this.localize('Resource Player'));
      }
    ...
    /**
     * Destroys the resource player and does any necessary cleanup.
     *
    ...
    _proto.createEl = function createEl() {
      ...
      var divEmbed = this.tag.tagName.toLowerCase() === 'resource-js';
      ...
      // ID will now reference player box, not the resource tag
      ...
      if (divEmbed) {
        ...
        if (!hasClass(el, 'resource-js')) {
          addClass(el, 'resource-js');
        }

        el.appendChild(tag);
        playerElIngest = this.playerElIngest_ = el; // move properties over from our custom `resource-js` element
        // to our new `resource` element. This will move things like
      ...
      } // set tabindex to -1 to remove the resource element from the focus order
      ...
      Object.getOwnPropertyNames(attrs).forEach(function (attr) {
        ...
        // and we want to make sure that the `resource-js` class doesn't get lost
      ...
      // doesn't flash 100% width/height, but class only applies with .resource-js parent

      tag.playerId = tag.id;
      tag.id += '_html5_api';
      tag.className = 'vjs-tech'; // Make player findable on elements

      tag.player = el.player = this; // Default state of resource is paused
      ...
      this.aspectRatio(this.options_.aspectRatio); // Hide any links within the resource/audio tag,
      ...
      tag.initNetworkState_ = tag.networkState; // Wrap resource tag in div (el/box) container
    ...
    _proto.updateStyleEl_ = function updateStyleEl_() {
      ...
      if (this.aspectRatio_ !== undefined && this.aspectRatio_ !== 'auto') {
        ...
        // Otherwise try to get the aspect ratio from the resource metadata
        aspectRatio = this.videoWidth() + ':' + this.videoHeight();
      } else {
        // Or use a default. The resource element's is 2:1, but 16:9 is more common.
        aspectRatio = '16:9';
      ...
      if (this.width_ !== undefined) {
        ...
        // Or use the resource's metadata, or use the resource el's default of 300
    ...
    _proto.loadTech_ = function loadTech_(techName, source) {
      ...
      var camelTechName = techName.charAt(0).toLowerCase() + techName.slice(1); // get rid of the HTML5 resource tag as soon as we are using another tech
      ...
      // Make sure to not insert the original resource element if using Html5


      if (this.tech_.el().parentNode !== this.el() && (titleTechName !== 'Html5' || !this.tag)) {
        prependTo(this.tech_.el(), this.el());
      } // Get rid of the original resource tag reference after the first tech is loaded
     ...
     *
     * - On desktops: a click on the resource itself will toggle playback
     * - On mobile devices: a click on the resource toggles controls
     ...
     * is a touch and hold on the resource element counting as activity in order to
     ...
     * This event is a custom event from Resource.js and is triggered by the {@link Tech}.
     *
     * The event object for this event contains a `src` property that will contain the source
     * that was available when the event was triggered. This is generally only necessary if Resource.js
    ...
    _proto.handleTechRateChange_ = function handleTechRateChange_() {
      ...
      /**
       * Fires when the playing speed of the audio/resource is changed
       *
    ...
    _proto.handleTechFirstPlay_ = function handleTechFirstPlay_() {
      ...
      this.addClass('vjs-has-started');
      /**
       * Fired the first time a resource is played. Not part of the HLS spec, and this is
    ...
    /**
     * Fires when an error occurred during the loading of an audio/resource.
     *
     * @private
     * @listens Tech#error
     */
    ...
    _proto.techGet_ = function techGet_(method) {
      ...
      try {
        ...
        if (this.tech_[method] === undefined) {
          log("Resource.js: " + method + " method not defined for " + this.techName_ + " playback technology.", e);
          throw e;
        } // When a method isn't available on the object it throws a TypeError


        if (e.name === 'TypeError') {
          log("Resource.js: " + method + " unavailable on " + this.techName_ + " playback technology element.", e);
    ...
    _proto.play_ = function play_(callback) {
      ...
      if (!this.isReady_ || !isSrcReady) {
        ...
        // in that case, we need to prime the resource element by calling load so it'll be ready in time
    ...
    /**
     * Normally gets the length in time of the resource in seconds;
     * in all but the rarest use cases an argument will NOT be passed to the method
     *
     * > **NOTE**: The resource must have started loading before the duration can be
     * known, and in the case of Flash, may not be known until the resource starts
     * playing.
     *
     * @fires Player#durationchange
     *
     * @param {number} [seconds]
     *        The duration of the resource to set in seconds
     *
     * @return {number}
     *         - The duration of the resource in seconds when getting
     */
    ;
    ...
    _proto.duration = function duration(seconds) {
      ...
      seconds = parseFloat(seconds); // Standardize on Infinity for signaling resource is live
    ...
    /**
     * Calculates how much time is left in the resource. Not part
     * of the native resource API.
     *
     * @return {number}
    ...
    // Kind of like an array of portions of the resource that have been downloaded.

    /**
     * Get a TimeRange object with an array of the times of the resource
     * that have been downloaded. If you just want the percent of the
     * resource that's been downloaded, use bufferedPercent.
     *
    ...
    /**
     * Get the percent (as a decimal) of the resource that's been downloaded.
     * This method is not a part of the native HTML resource API.
     *
     * @return {number}
    ...
    /**
     * Increase the size of the resource to full screen
     * In some browsers, full screen is not supported natively, so it enters
     * "full window mode", where the resource fills the browser window.
     * In browsers and devices that support native full screen, sometimes the
     * browser's default controls will be shown, and not the Resource.js custom skin.
    ...
    _proto.requestFullscreen = function requestFullscreen(fullscreenOptions) {
      ...
      if (this.fsApi_.requestFullscreen) {
        ...
        // take the controls fullscreen as well as the resource
        ...
        // we can't take the resource.js controls fullscreen but we can go fullscreen
        // with native controls
        this.techCall_('enterFullScreen');
      } else {
        // fullscreen isn't supported so we'll just stretch the resource element to
        // fill the viewport
    ...
    /**
     * Return the resource to its normal size after having been in full screen mode
     *
     * @fires Player#fullscreenchange
     */
    ;
     ...
     * resource container to as wide as the browser will let us.
     *
    ...
    /**
     * Get or set the resource source.
     *
    ...
    /**
     * Get the current source type e.g. resource/mp4
    ...
    /**
     * Get or set the loop attribute on the resource element.
     *
     * @param {boolean} [value]
     *        - true means that we should loop the resource
     *        - false means that we should not loop the resource
     *
     * @return {boolean}
    ...
    /**
     * Get or set the poster level source url
     *
     * @fires Player#posterchange
     *
     * @param {string} [src]
     *        Poster level source URL
     *
     * @return {string}
    ...
    _proto.poster = function poster(src) {
      ...
      /**
       * This event fires when the poster level is changed on the player.
       *
     ...
     * defaultPlaybackRate will only represent what the initial playbackRate of a resource was, not
     ...
     * automatically removed from the resource element whenever the source changes, unless
     ...
     *           URL to an level that will display before playback.
     *
   ...
   *
   * @return {VideoTrackList}
   *         the current resource track list
   *
  ...
  ALL.names.forEach(function (name) {
    ...
    Player.prototype[props.getterName] = function () {
      ...
      } // if we have not yet loadTech_, we create {resource,audio,text}Tracks_
  ...
  Player.prototype.options_ = {
    ...
    languages: {},
    // Default message to show when a resource cannot be played.
  ...
  function () {
    ...
    /**
     * De-register a Resource.js plugin.
     *
     * @param  {string} name
    ...
    /**
     * Gets an object containing multiple Resource.js plugins.
     *
     * @param   {Array} [names]
   ...
   *
   * Resource element or resource element ID.
   *
   * ##### options
   * Object, optional
   *
  ...
  // resource in the DOM (weird behavior only with minified version)


  autoSetupTimeout(1, videojs$1);
  /**
   * Current Resource.js version. Follows [semantic versioning](https://semver.org/).
   *
   * @type {string}
   */
   ...
   * Resource.js player, but not create one if it doesn't.
   *
   * @param   {string|Element} id
   *          An HTML element - `<resource>`, `<audio>`, or `<resource-js>` -
  ...
  /**
   * Deprecated method to register a plugin with Resource.js
   *
